...
import pa.lab1.optional.Destination;
import pa.lab1.optional.Source;
...
public class Solution {
     ...
     * @param sources - the sources - can be Warehouse, Factory
     */
    public Solution(int[][] costMatrix, int[] supplyAmounts, int[] demandAmounts, Source[] sources) {
